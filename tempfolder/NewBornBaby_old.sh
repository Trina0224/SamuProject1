...
sudo mount /dev/sdb1 /mnt/temp1
echo "Create SSD2"
(echo d; echo n; echo ""; echo ""; echo ""; echo "";echo p; echo w; echo y) | sudo gdisk /dev/sdc
(echo y) | sudo mkfs.ext4 /dev/sdc1
sudo mount /dev/sdc1 /mnt/temp2
echo "Create HDD"
